...
<?php }else{?>
<video id="view-video" class="video-skin"  poster="" controls autoplay loop>
<source src="<?php echo HTTP_DOWNLOAD . $video['filename_mp4'];?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'/>
</video>
<?php }?>
</div>
</div>