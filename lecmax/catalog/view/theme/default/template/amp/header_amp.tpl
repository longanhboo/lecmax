...
<script type="application/ld+json">{"@context": "http://schema.org","@type": "Organization",  "url": "<?php echo HTTP_SERVER;?>","name": "LDG GROUP","logo": ["<?php echo PATH_TEMPLATE;?>default/images/social-share.png"], "contactPoint": {"@type": "ContactPoint",  "telephone": "+84-28-3862-5726","contactType": "Customer service"}}</script>
...
.ampstart-nav-item .ampstart-nav-link::after { background-color:#f1662f; top: -1px; bottom: -1px }
.ampstart-nav-item .ampstart-sidebar-nav-item-image {background-color: #ef402a }
...
.ampstart-sidebar-nav-logo {width:100%; top:8px; left:0;  font-size:0; line-height:0; text-indent:-9999px; color:#ef402a; pointer-events:none}
...
.ampstart-image-banner footer{position:absolute;left:0;right:0;bottom:-7rem; z-index:6; display:none}
...
.ampstart-image-banner > figcaption{left:0;/*bottom:0*/bottom:-14rem;right:0;margin:1.5rem;color:#fff}
...
.gallery-landing-image-wrapped amp-img { -o-object-fit: cover; object-fit: cover; box-shadow: 1vh 6vh 5vh rgba(6,7,22,.15); pointer-events: none;background-color: #ef402a }
...
.gallery-landing-image-caption { position: absolute; top:0; left:0;  color: #fff;padding: .7em 1.2em;   background-color:#f1662f ;  -webkit-transition: all .2s ease-in-out; transition: all .2s ease-in-out; z-index:2; }
.gallery-landing-image-caption::after { content: ""; position: absolute; top: 0; left: 0; width: 100%; height: 100%;background-color:#ef402a ; -webkit-transform: scaleX(0) rotateX(1turn); transform: scaleX(0) rotateX(1turn); -webkit-transform-origin: top left; transform-origin: top left;z-index: -1 }
...
/*CONTENT*/
.content-post{width:100%; max-width:1200px;padding:3rem 0 0 0;margin:120px auto 2rem auto;  z-index:5}
.content-post h1{ color:#ef402a}
...
.ampstart-article-summary:nth-child(odd) {background-color:#eee;color:#666;}
...
.logo{width:160px;height: 55px;display:block;margin:0 auto;}
.logo-company {width:100%;height:100%;background:url(<?php echo PATH_TEMPLATE;?>default/images/logo.svg) no-repeat center center / contain; display:block; }

.logo-value{margin-top:3rem}

.ampstart-image-with-caption figcaption{left:0;right:0;bottom:0;padding:1.5rem;background-color:rgba(0,0,0,0.3);color:#fff}
.content-post article:nth-child(odd) h2{ font-weight:900; margin:1rem 0; font-size:3rem; line-height:1; color:#526f81; z-index:5 }
...
.ampstart-nav-item:hover .ampstart-sidebar-nav-item-text{color:#fff}
.value-contact-text{line-height: 1.6;
    margin-bottom: 1rem;
    font-size: 1.4rem;
...
.r-date{display:inline-block;width:auto;height:auto;margin:0;padding:10px;background-color:#c01803;font-family:'Montserrat', sans-serif;font-weight:700;font-size:12px;color:#fff;vertical-align:middle;line-height:1;-webkit-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.load-content-news .r-date{ position:absolute; top:0px;right:0; background-color:#f1662f }


.append-items td{    line-height: 1.6;
    margin-bottom: 1rem;
    font-size: 1.4rem;
    font-weight: 300;}

/*ABOUT*/
.manager-content{text-align:center}
.manager-box{display:block;width:100%;height:auto;margin:30px auto;max-width:1150px;text-align:center;}
.leader-box{display:inline-block;position:relative;width:auto;height:auto;max-width:20%;margin:0 2% 2% 2%;vertical-align:top}
/*.leader-box:nth-child(1){max-width:90%;width:100%;}*/
.leader-pic{display:block;width:230px;height:auto;position:relative;margin:0 auto;-webkit-border-radius:50%;border-radius:50%;}
...
.title h3{font-weight: 700;margin: 1rem 0;font-size: 2.5rem;line-height: 1;z-index: 5;}



.report{position:relative;display:block;width:100%;height:auto;text-align:center}
.share-box{position:relative;display:block;width:100%;height:auto;padding:0 0 30px 0; text-align:center}
.share-box .outer-but{display:inline-block;width:auto;height:auto}



.post-text a.share-but{position:relative;display:inline-block;margin-top:60px;width:146px;height:146px;line-height:146px;background:-webkit-linear-gradient(135deg, rgb(0, 156, 224) 0%, rgb(0, 55, 104) 100%);background:linear-gradient(135deg, rgb(0, 156, 224) 0%, rgb(0, 55, 104) 100%);text-align:center;-webkit-border-radius:50%;border-radius:50%;text-align:center;-webkit-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.post-text a.share-but span{display:inline-block;margin-top:-10px;line-height:1.2; font-family:'Futurab';font-weight:normal;font-size:18px;color:#fff;text-transform:uppercase;vertical-align:middle}
.post-text a.share-but::before{content:'';position:absolute;left:-20px;top:-20px;width:calc(100%);height:calc(100%);border:20px solid #838383;opacity:0.2;-webkit-border-radius:50%;border-radius:50%}


.share-but:hover{-webkit-transform:scale(0.96);transform:scale(0.96)}




.r-pdf{display:inline-block;width:40px;height:42px;background:url(<?php echo PATH_TEMPLATE;?>default/images/icon-download.png) no-repeat center center;vertical-align:middle;background-size:contain}
.r-zip{display:inline-block;width:40px;height:42px;background:url(<?php echo PATH_TEMPLATE;?>default/images/zip.png) no-repeat center center;vertical-align:middle;background-size:contain}


.list-box{position:relative;display:inline-block;width:48%;margin:0.5%;}
.list-box.hide{display:none}

.list-box a{position:relative;display:block;width:100%;height:auto; text-decoration:none;}
.list-outer{display:block;width:100%;height:80px;position:relative;font-family:Arial, Helvetica, sans-serif;-webkit-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out;background-color:rgba(255,255,255,1);-webkit-border-radius:30px;border-radius:30px;}

.r-left{position:relative;display:block;width:auto;height:100%;float:left;padding:0 20px;line-height:80px;overflow:hidden;vertical-align:middle;}
.r-text{position:relative;display:block;width:auto;height:100%;line-height:80px;text-align:left;padding:0 80px 0 0;overflow:hidden;vertical-align:middle;}
.r-link{position:absolute;right:0;top:0;width:auto;height:100%;line-height:80px;padding:0 20px}

.r-num{display:inline-block;width:36px;height:36px;margin:0;background-color:#ef402a;-webkit-border-radius:50%;border-radius:50%;font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:34px;text-align:center;color:#fff;vertical-align:middle;font-weight:bold;-webkit-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}
.r-date{display:inline-block;width:auto;height:auto;margin:0;padding:10px;background-color:#f1662f;font-family:'Montserrat', sans-serif;font-weight:700;font-size:12px;color:#fff;vertical-align:middle;line-height:1;-webkit-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out}

.r-text p{display:inline-block;vertical-align:middle;font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:1.4;color:#606060;max-height:60px;overflow:hidden;-webkit-transition:all 0.3s ease-in-out;transition:all 0.3s ease-in-out; max-width:90%;}

.r-left::before, .r-left::after, .r-text::before, .r-text::after, .r-link::before, .r-link::after{content:''; height:100%; display:inline-block; vertical-align:middle}


.list-outer:hover{background-color:#f1662f;}
.list-outer:hover p{color:#fff;}

.list-outer:hover .r-date, .list-outer:hover .r-num{background-color:#fff;color:#f1662f}

.report{position:relative;display:block;width:100%;height:auto;text-align:center}
.report-wrap{position:relative;display:block;width:100%;height:auto;padding:60px 0;}
.relation-box{position:relative;display:block;width:100%;height:auto;max-width:970px;margin:0 auto;font-size:0;min-height:160px;}
.report-02 .r-left{padding:0 20px 0 0}

.report-04{z-index:1}
.report-04 .relation-box{max-width:1250px}

.news-link li{display:list-item; list-style:square}
.news-link li a{padding:0}

@media (max-width:93.75rem) {
.ampstart-image-banner > figcaption{bottom:-10rem}
}
...
.post-text p, .post-text a{font-size: 1.2rem; }
.append-items td{    line-height: 1.2;
    margin-bottom: 1rem;
    font-size: 1.2rem;
    font-weight: 300;}
...
.title-page{color:#ef402a; font-size:2rem;}
...
.ampstart-image-banner > figcaption{margin:0; bottom:-6rem}
...
.box-nav ul{white-space:normal}

.content-post{margin:60px auto 2rem auto}

}

@media screen and (orientation:portrait) {
.ampstart-image-banner > amp-img {height:calc(100vh/2); width:100vw }
}
