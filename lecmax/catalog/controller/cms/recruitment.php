<?php
class ControllerCmsRecruitment extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->data['recruitments'] = $this->model_cms_recruitment->getRecruitments($arr_path[0]);
	...
	public function detail() {
		...
		$this->data['recruitment'] = $this->model_cms_recruitment->getRecruitment($recruitment_id);

		$template = 'recruitment_detail.tpl';
		$seo = $this->data['recruitment'];
