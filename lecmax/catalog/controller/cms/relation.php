<?php
class ControllerCmsRelation extends Controller {
	private $error = array();
	...
	public function __construct($registry) {
		...
		$langs = $this->model_catalog_lang->getLangByModule('relation',1);
	...
	public function index() {
		...
		$this->data['relations'] = $this->model_cms_relation->getRelations($arr_path[0]);

		$template = 'relation.tpl';
	...
	public function detail() {
		...
		$relation_id = isset($this->request->get['relation_id'])?	(int)$this->request->get['relation_id']:0;

		$this->data['relation'] = $this->model_cms_relation->getRelation($relation_id);

		$template = 'relation_detail.tpl';
		$seo = $this->data['relation'];
