<?php
class ControllerCmsStatus extends Controller {
	private $error = array();
	...
	public function __construct($registry) {
		...
		$langs = $this->model_catalog_lang->getLangByModule('status',1);
	...
	public function index() {
		...
		$this->data['statuss'] = $this->model_cms_status->getStatuss($arr_path[0]);
	...
	public function detail() {
		...
		$status_id = isset($this->request->get['status_id'])?	(int)$this->request->get['status_id']:0;

		$this->data['status'] = $this->model_cms_status->getStatus($status_id);

		$template = 'status_detail.tpl';
		$seo = $this->data['status'];
