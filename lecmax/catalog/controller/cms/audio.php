<?php
class ControllerCmsAudio extends Controller {
	private $error = array();
	...
	public function __construct($registry) {
		...
		$langs = $this->model_catalog_lang->getLangByModule('audio',1);
	...
	public function index() {
		...
		$this->data['audios'] = $this->model_cms_audio->getAudios($arr_path[0]);
	...
	public function detail() {
		...
		$audio_id = isset($this->request->get['audio_id'])?	(int)$this->request->get['audio_id']:0;

		$this->data['audio'] = $this->model_cms_audio->getAudio($audio_id);

		$template = 'audio_detail.tpl';
		$seo = $this->data['audio'];
