<?php
class ControllerCmsCustomers extends Controller {
	private $error = array();
	...
	public function __construct($registry) {
		...
		$langs = $this->model_catalog_lang->getLangByModule('customers',1);
	...
	public function index() {
		...
		$this->data['customerss'] = $this->model_cms_customers->getCustomerss($arr_path[0]);

		$template = 'customers.tpl';
	...
	public function detail() {
		...
		$customers_id = isset($this->request->get['customers_id'])?	(int)$this->request->get['customers_id']:0;

		$this->data['customers'] = $this->model_cms_customers->getCustomers($customers_id);

		$template = 'customers_detail.tpl';
		$seo = $this->data['customers'];
