<?php
class ControllerCmsEmailcus extends Controller {
	private $error = array();
	...
	public function __construct($registry) {
		...
		$langs = $this->model_catalog_lang->getLangByModule('emailcus',1);
	...
	public function index() {
		...
		$this->data['emailcuss'] = $this->model_cms_emailcus->getEmailcuss($arr_path[0]);

		$template = 'emailcus.tpl';
	...
	public function detail() {
		...
		$emailcus_id = isset($this->request->get['emailcus_id'])?	(int)$this->request->get['emailcus_id']:0;

		$this->data['emailcus'] = $this->model_cms_emailcus->getEmailcus($emailcus_id);

		$template = 'emailcus_detail.tpl';
		$seo = $this->data['emailcus'];
