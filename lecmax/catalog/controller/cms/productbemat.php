<?php
class ControllerCmsProductbemat extends Controller {
	private $error = array();
	...
	public function __construct($registry) {
		...
		$langs = $this->model_catalog_lang->getLangByModule('productbemat',1);
	...
	public function index() {
		...
		$this->data['productbemats'] = $this->model_cms_productbemat->getProductbemats($arr_path[0]);

		$template = 'productbemat.tpl';
	...
	public function detail() {
		...
		$productbemat_id = isset($this->request->get['productbemat_id'])?	(int)$this->request->get['productbemat_id']:0;

		$this->data['productbemat'] = $this->model_cms_productbemat->getProductbemat($productbemat_id);

		$template = 'productbemat_detail.tpl';
		$seo = $this->data['productbemat'];
