...
class ModelUserUserGroup extends Model {
	private $permission = array('1'=>array(1,12,13,11), '12'=>array(12,13,11), '13'=>array(13,11), '11'=>array(11));
	...
	public function getUserGroupName($user_group_id) {
		$query = $this->db->query("SELECT name FROM " . DB_PREFIX . "user_group WHERE user_group_id = '" . (int)$user_group_id . "'");
	...
	public function getUserGroups($data = array()) {
		...
		$sql .= "  WHERE user_group_id IN (" . $cond . ")";
