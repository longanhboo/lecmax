				...
				<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
					<div class="table-responsive">
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									<td class="text-center;" width="1" <?php if($superadmin==false) echo 'style="display:none"';?>><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
									<td class="text-center" width="70px"><?php echo $column_sort_order; ?></td>
									<td class="text-left"><?php echo $column_name; ?></td>
									<td class="text-center"><?php echo $column_type; ?></td>
									<td class="text-center"><?php echo $column_mainmenu; ?></td>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center"><?php echo $category['type']; ?></td>
									<td class="text-center"><?php echo $category['mainmenu']; ?></td>
                                    <td class="text-center status-en-display"><?php echo $category['status_en']; ?></td>
			...
			$(".sort_order").click(function(){
				...
				if(isNaN(sort_order)===false)
				{
					...
					$.ajax({
						...
						type: 'POST',
						data: 't=category&id=' + encodeURIComponent(id) + '&sort_order=' + sort_order + '&cate_type=menu' + '&isclick=1',
						dataType: 'text',
			...
			$(".sort_order").blur(function(){
				...
				if(isNaN(sort_order)===false)
				{
					$.ajax({
						url: 'index.php?route=catalog/sortorder&token=<?php echo $token; ?>',
						type: 'POST',
						data: 't=category&id=' + encodeURIComponent(id) + '&sort_order=' + sort_order + '&cate_type=menu',
						dataType: 'text',
						success: function(data) {
