						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
                                    ...
                                    <td class="text-left" style="display:none" ><?php echo $column_comment; ?></td>
							...
							<tbody>
								<tr>
                                    ...
                                    <td style="display:none" ><input type="text" id="filter_address" name="filter_address" value="<?php echo $filter_address; ?>"  class="form-control" /></td>
                                    ...
                                    <td style="display:none"></td>
                                    <td style="display:none" ><input style="display:none" type="text" id="filter_comment" name="filter_comment" value="<?php echo $filter_comment; ?>"  class="form-control" /></td>
								...
								<?php if ($ungviens) { ?>
								<?php foreach ($ungviens as $ungvien) { ?>
								<tr>
									<td class="text-center"><?php if ($ungvien['selected']) { ?>
										<input type="checkbox" name="selected[]" value="<?php echo $ungvien['ungvien_id']; ?>" checked="checked" />
										<?php } else { ?>
										<input type="checkbox" name="selected[]" value="<?php echo $ungvien['ungvien_id']; ?>" />
										<?php } ?>
									</td>
									<td class="text-center"><input type="text" onkeypress="return checkIt(event);" style="width:25px" class="sort_order text-center" ungvienid="<?php echo $ungvien['ungvien_id'];?>" value="<?php echo $ungvien['sort_order'];?>" /></td>
									<!--{VALUE_IMAGE}-->
									<td class="text-left"><?php echo $ungvien['name']; ?></td>
                                    <td class="text-left" style="display:none"><?php echo $ungvien['cmnd']; ?></td>
                                    <td class="text-left"><?php echo $ungvien['email']; ?></td>
                                    <td class="text-left" ><?php echo $ungvien['phone']; ?></td>
                                    <td class="text-left"  style="display:none"><?php echo $ungvien['company']; ?></td>
                                    <td class="text-left"  style="display:none"><?php echo $ungvien['address']; ?><!-- - <?php echo $ungvien['district']; ?> - <?php echo $ungvien['city']; ?>--></td>
                                    <td class="text-left" style="display:none"><?php echo $ungvien['canhoquantam']; ?></td>
                                    <td class="text-left" style="display:none"><?php echo $ungvien['giaquantam']; ?></td>
                                    <td class="text-center"  style="display:none"><?php if($ungvien['is_mail']==1) echo $text_lien_he; else echo $text_dat_cau_hoi;?></td>
                                    <td class="text-left" style="display:none" ><?php echo $ungvien['comment']; ?></td>
                                    <td class="text-left"><?php echo $ungvien['date_added']; ?></td>
                                    <!--{VALUE}-->
                                    
									<td class="text-center"  >
										<?php if ($ungvien['status_id']==1): ?>
											<input type="checkbox" checked="checked" class="status" ungvienid="<?php echo $ungvien['ungvien_id'];?>" data-status="<?php echo $ungvien['status_id'] ?>">
										<?php else: ?>
											<input type="checkbox" class="status" ungvienid="<?php echo $ungvien['ungvien_id'];?>" data-status="<?php echo $ungvien['status_id'] ?>">
										<?php endif ?>
									</td>
									<td class="text-right"><?php foreach ($ungvien['action'] as $action) { ?>
		...
		$(".sort_order").click(function(){
			...
			if(isNaN(sort_order)===false)
			{
				$.ajax({
					...
					type: 'POST',
					data: 't=ungvien&id=' + encodeURIComponent(id) + '&sort_order=' + sort_order + '&isclick=1',
					dataType: 'text',
		...
		$(".sort_order").blur(function(){
			...
			if(isNaN(sort_order)===false)
			{
				$.ajax({
					url: 'index.php?route=catalog/sortorder&token=<?php echo $token; ?>',
					type: 'POST',
					data: 't=ungvien&id=' + encodeURIComponent(id) + '&sort_order=' + sort_order,
					dataType: 'text',
					success: function(data) {
		...
		$(".ishome").on('click', function(){
			...
			if(isNaN(ishome)===false) {
				$.ajax({
					url: 'index.php?route=catalog/sortorder&token=<?php echo $token; ?>',
					type: 'POST',
					data: 't=ungvien&id=' + encodeURIComponent(id) + '&ishome=' + ishome,
					dataType: 'text',
					success: function(data) {
	...
	$(".status").on('click', function(){
		...
		if(isNaN(status)===false) {
			$.ajax({
				url: 'index.php?route=catalog/sortorder&token=<?php echo $token; ?>',
				type: 'POST',
				data: 't=ungvien&id=' + encodeURIComponent(id) + '&status=' + status,
				dataType: 'text',
				success: function(data) {
