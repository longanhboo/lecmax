		...
		/*$(".sort_order").click(function(){
			...
			if(isNaN(sort_order)===false)
			{
				...
				$.ajax({
					...
					type: 'POST',
					data: 't=category&id=' + encodeURIComponent(id) + '&sort_order=' + sort_order + '&cate_type=cateproduct' + '&isclick=1',
					dataType: 'text',
		...
		$(".sort_order").blur(function(){
			...
			if(isNaN(sort_order)===false)
			{
				$.ajax({
					url: 'index.php?route=catalog/sortorder&token=<?php echo $token; ?>',
					type: 'POST',
					data: 't=category&id=' + encodeURIComponent(id) + '&sort_order=' + sort_order + '&cate_type=cateproduct',
					dataType: 'text',
					success: function(data) {
