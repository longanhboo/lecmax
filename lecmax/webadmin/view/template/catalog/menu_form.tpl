...
<div id="content">
						...
						<div class="tab-pane active" id="tab-general">
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                    ...
                                    <div class="form-group" style="display:none" <?php if($category_id!=96 && $category_id!=330 && $category_id!=164 && $category_id!=94 && $category_id!=329 && $category_id!=336 && $category_id!=92 && $category_id!=372) echo 'style="display:none"';?> >
										<label class="col-sm-2 control-label" for="input-name1<?php echo $language['language_id']; ?>"><?php echo $entry_name1_menu; ?></label>
										<div class="col-sm-10">
								...
								<table id="images" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr id="image-row<?php echo $image_row; ?>">
                                            ...
                                            <td class="text-left" style="width:20%;min-width:250px;">
	...
	<script type="text/javascript">
		...
		function addImage() {
			...
			html += '  <td class="text-left"><a href="" id="thumb-image-1' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php if(empty($preview_2)) echo 'view/image/image.png'; else echo $preview_2; ?>" alt="" title=""  /><input type="hidden" name="category_image[' + image_row + '][image1]" value="" id="input-image-1' + image_row + '" /></td>';
			
			html += '<td class="text-center" style="width:20%;min-width:250px; "><div class="input-group"><span class="input-group-addon"><img src="view/image/flags/vn.png" /></span><textarea name="category_image[' + image_row + '][image_name]" class="form-control" style="height:70px;resize:none;" cols="30" rows="3" ></textarea></div>';
