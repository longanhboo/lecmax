...
<div id="content">
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                    ...
                                    <div class="form-group" style="display:none" >
										<label class="col-sm-2 control-label" for="input-name1<?php echo $language['language_id']; ?>"><?php echo $entry_name1_catealbum; ?></label>
										<div class="col-sm-10">
											<input type="text" name="category_description[<?php echo $language['language_id']; ?>][name1]"  id="input-name1<?php echo $language['language_id']; ?>" class="form-control" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['name1'] : ''; ?>">
										</div>
									</div>
								...
								<div class="form-group  required" style="display:none" >
									<label class="col-sm-2 control-label">
										<span data-toggle="tooltip" title="<?php echo $help_entry_image_catealbum; ?>"><?php echo $entry_image; ?></span><br/>
										<p class="s-mobile s-mobile-help"><?php echo $help_entry_image_catealbum ?></p>
									</label>
									<div class="col-sm-10">
								...
								<table id="images" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											<td class="text-left required">
												<span data-toggle="tooltip" title="<?php echo $help_column_images_catealbum; ?>"><?php echo $column_images;?></span><br/>
												<p class="s-mobile s-mobile-help"><?php echo $help_column_images_catealbum ?></p>
											</td>
									...
									<tbody id="image_row">
										...
										<tr id="image-row<?php echo $image_row; ?>">
											...
											<td class="text-left" style="display:none"><a href="" id="thumb-image-1<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php if(empty($category_image['preview_2'])) echo 'view/image/image.png'; else echo $category_image['preview_2']; ?>" alt="" title="" data-placeholder="<?php echo $image1; ?>" /></a><input type="hidden" name="category_image[<?php echo $image_row; ?>][image1]" value="<?php echo $category_image['image_2']; ?>" id="input-image-1<?php echo $image_row; ?>" /></td>
	...
	<script type="text/javascript">
		<?php foreach ($languages as $language) { ?>
			...
			$('#input-name1' + <?php echo $language['language_id']; ?>).parent().find('.note-style.btn-group').css('display','none');
			*/
			<?php } ?>
		//
	</script>
...
function checkMaxBackground(){
	...
	if(category_id==1){
		...
		function addImage() {
			...
			html += '  <td class="text-left" style="display:none"><a href="" id="thumb-image1' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php if(empty($preview1)) echo "view/image/image.png"; else echo $preview1; ?>" alt="" title="" data-placeholder="<?php echo $image1; ?>" /><input type="hidden" name="category_image[' + image_row + '][image1]" value="" id="input-image1' + image_row + '" /></td>';
