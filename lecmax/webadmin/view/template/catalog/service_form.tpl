	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-service" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i> <lbl class="s-mobile"><?php echo $button_save; ?></lbl></button>
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-service" class="form-horizontal">
					...
					<ul class="nav nav-tabs">
						...
						<li class="display_design_album" <?php if($cate && $service_id!=5) echo 'style="display:none"';?> ><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
<li <?php if($cate && $cate_service['typeservice']!='2') echo 'style="display:none"';?> ><a href="#tab-seo" data-toggle="tab"><?php echo $tab_seo;?></a></li>
<li style="display:none"><a href="#tab-video" data-toggle="tab"><?php echo $tab_video; ?></a></li>
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
									...
									<div class="form-group required">
										...
										<div class="col-sm-10">
											<input type="text" name="service_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($service_description[$language['language_id']]) ? $service_description[$language['language_id']]['name'] : ''; ?>"  id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
									...
									<div class="form-group display_type1 display_design_nd" <?php if($service_id==1 || $service_id==5) echo 'style="display:none"';?> >
										<label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?></label>
										<div class="col-sm-10">
											<textarea name="service_description[<?php echo $language['language_id']; ?>][description]"  id="input-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($service_description[$language['language_id']]) ? $service_description[$language['language_id']]['description'] : ''; ?></textarea>
										</div>
									</div>
									<!--{INSERT_FIELD_LANG}-->
								</div>
           ...
           <div class="form-group required" style="display:none" <?php if($cate) echo 'style="display:none"';?> >
              <label class="col-sm-2 control-label" for="typeservice"><?php echo $entry_typeservice; ?></label>
              <div class="col-sm-10">
                <select name="typeservice" id="typeservice" class="form-control">
                	<option value="2" <?php if ($typeservice == '2') echo 'selected="selected"'; ?> ><?php echo $entry_danh_sach_tu_van; ?></option>
                  <option value="1" <?php if ($typeservice == '1') echo 'selected="selected"'; ?> ><?php echo $entry_danh_sach_thiet_ke; ?></option>
                  <option value="0" <?php if ($typeservice == '0') echo 'selected="selected"'; ?> ><?php echo $entry_bai_viet; ?></option>
            ...
            <div class="form-group required" style="display:none" <?php if(!$cate) echo 'style="display:none"';?> >
              <label class="col-sm-2 control-label" for="typedesign"><?php echo $entry_typedesign; ?></label>
              <div class="col-sm-10">
                <select name="typedesign" id="typedesign" class="form-control">
                  <option value="1" <?php if ($typedesign == '1') echo 'selected="selected"'; ?> ><?php echo $entry_danh_sach_hinh; ?></option>
                  <option value="0" <?php if ($typedesign == '0') echo 'selected="selected"'; ?> ><?php echo $entry_bai_viet; ?></option>
								...
								<div class="form-group required" <?php if(isset($cate_service['typeservice']) && $cate_service['typeservice']!='2') echo 'style="display:none"';?> >
            ...
            <div class="table-responsive">
                <table id="images" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <td class="text-left required" <?php if(!$cate) echo 'style="display:none"';?> ><?php echo $column_images_name; ?></td>
                        ...
                        <tr id="image-row<?php echo $image_row; ?>">
                            <td class="text-left">
                                <a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail">
                                    <img src="<?php if(empty($service_image['preview_1'])) echo 'view/image/image.png'; else echo $service_image['preview_1']; ?>" alt="" title="" data-placeholder="<?php echo $image; ?>" />
                                </a>
                                <input type="hidden" name="service_image[<?php echo $image_row; ?>][image]" value="<?php echo $service_image['image_1']; ?>" id="input-image<?php echo $image_row; ?>" />
                            </td>
                            <td class="text-left" style="display:none">
                                <a href="" id="thumb-image-1<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail">
                                    <img src="<?php if(empty($service_image['preview_2'])) echo 'view/image/image.png'; else echo $service_image['preview_2']; ?>" alt="" title="" data-placeholder="<?php echo $image1; ?>" />
                                </a>
                                <input type="hidden" name="service_image[<?php echo $image_row; ?>][image1]" value="<?php echo $service_image['image_2']; ?>" id="input-image-1<?php echo $image_row; ?>" />
                            </td>
                            
                            <td class="text-left" style="width:70%;min-width:150px; <?php if(!$cate) echo 'display:none';?>">
                                <div class="input-group">
                                    <span class="input-group-addon"><img src="view/image/flags/vn.png" /></span>
                                    <textarea cols="30" rows="3" style="height:70px;resize:none;" name="service_image[<?php echo $image_row; ?>][image_name]" class="form-control"><?php echo isset($service_image['image_name']) ? $service_image['image_name'] : ''; ?></textarea>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon"><img src="view/image/flags/gb.png" /></span>
                                    <textarea cols="30" rows="3" style="height:70px;resize:none;"  name="service_image[<?php echo $image_row; ?>][image_name_en]" class="form-control"><?php echo isset($service_image['image_name_en']) ? $service_image['image_name_en'] : ''; ?></textarea>
                                </div>
                            </td>
    
                            <td class="text-left"><input style="width:40px" type="text" name="service_image[<?php echo $image_row; ?>][image_sort_order]" value="<?php echo $service_image['image_sort_order']; ?>" class="form-control"/></td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td <?php if(!$cate) echo 'style="display:none"';?> ></td>
                            <td></td>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language-seo<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="service_description[<?php echo $language['language_id']; ?>][meta_title]"><?php echo $entry_meta_title ?></label>
                    <div class="col-sm-10">
                      <input class="form-control" id="service_description[<?php echo $language['language_id']; ?>][meta_title]" type="text" name="service_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($service_description[$language['language_id']]) ? $service_description[$language['language_id']]['meta_title'] : ''; ?>" />
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="service_description[<?php echo $language['language_id']; ?>][meta_description]"><?php echo $entry_meta_description ?></label>
                    <div class="col-sm-10">
                      <textarea class="form-control" name="service_description[<?php echo $language['language_id']; ?>][meta_description]" id="service_description[<?php echo $language['language_id']; ?>][meta_description]" ><?php echo isset($service_description[$language['language_id']]) ? $service_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="service_description[<?php echo $language['language_id']; ?>][meta_keyword]"><?php echo $entry_meta_keyword ?></label>
                    <div class="col-sm-10">
                      <textarea class="form-control" name="service_description[<?php echo $language['language_id']; ?>][meta_keyword]" id="service_description[<?php echo $language['language_id']; ?>][meta_keyword]" ><?php echo isset($service_description[$language['language_id']]) ? $service_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="service_description[<?php echo $language['language_id']; ?>][meta_title_og]"><?php echo $entry_meta_title_og; ?></label>
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="service_description[<?php echo $language['language_id']; ?>][meta_title_og]" id="service_description[<?php echo $language['language_id']; ?>][meta_title_og]" value="<?php echo isset($service_description[$language['language_id']]) ? $service_description[$language['language_id']]['meta_title_og'] : ''; ?>" />
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="service_description[<?php echo $language['language_id']; ?>][meta_description_og]" ><?php echo $entry_meta_description_og ?></label>
                    <div class="col-sm-10">
                      <textarea class="form-control"  name="service_description[<?php echo $language['language_id']; ?>][meta_description_og]" id="service_description[<?php echo $language['language_id']; ?>][meta_description_og]" ><?php echo isset($service_description[$language['language_id']]) ? $service_description[$language['language_id']]['meta_description_og'] : ''; ?></textarea>
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="service_keyword[<?php echo $language['language_id']; ?>][keyword]" >
                    ...
                    <div class="col-sm-10">
                        <input class="form-control"  name="service_keyword[<?php echo $language['language_id']; ?>][keyword]" id="service_keyword[<?php echo $language['language_id']; ?>][keyword]" value="<?php echo isset($service_keyword[$language['language_id']]) ? $service_keyword[$language['language_id']]['keyword'] : ''; ?>" />
                    </div>
                </div>
...
$(document).ready(function() {	
	...
	<?php if($cate==0){?>
	var typeservice = '<?php echo $typeservice;?>';
	if(typeservice==0){
		$('.display_type1').show();
	}else{
		$('.display_type1').hide();
	...
	<?php if(isset($cate_service['typeservice']) && $cate_service['typeservice']==1){?>
	var typedesign = '<?php echo $typedesign;?>';
	if(typedesign==0){
		$('.display_design_album').hide();
		$('.display_design_nd').show();
	}else if(typedesign==1){
		$('.display_design_album').show();
		$('.display_design_nd').hide();
	}

	
	$('#typedesign').change(function(){
		var typedesign = $(this).val();
		if(typedesign==0){
			$('.display_design_album').hide();
			$('.display_design_nd').show();
		}else if(typedesign==1){
...
function checkMaxBackground(){
	...
	var cate = <?php echo $cate; ?>;
	var display_name = '';
	if(!cate) display_name = 'display:none';

	function addImage() {
		html  = '<tr id="image-row' + image_row + '">';
		html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php if(empty($preview_1)) echo "view/image/image.png"; else echo $preview_1; ?>" alt="" title="" data-placeholder="<?php echo $image; ?>" /><input type="hidden" name="service_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
		
		html += '  <td class="text-left" style="display:none"><a href="" id="thumb-image-1' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php if(empty($preview_2)) echo "view/image/image.png"; else echo $preview_2; ?>" alt="" title="" data-placeholder="<?php echo $image1; ?>" /><input type="hidden" name="service_image[' + image_row + '][image1]" value="" id="input-image-1' + image_row + '" /></td>';

		html += '<td class="text-center" style="width:70%;min-width:150px;' + display_name + '"><div class="input-group"><span class="input-group-addon"><img src="view/image/flags/vn.png" /></span><textarea name="service_image[' + image_row + '][image_name]" class="form-control" style="height:70px;resize:none;" cols="30" rows="3" ></textarea></div>';

		html += '<div class="input-group"><span class="input-group-addon"><img src="view/image/flags/gb.png" /></span><textarea cols="30" rows="3" name="service_image[' + image_row + '][image_name_en]"  class="form-control" style="height:70px;resize:none;" ></textarea></div></td>';

		html += '  <td class="text-right"><input style="width:40px" type="text" name="service_image[' + image_row + '][image_sort_order]" value="' + image_row + '" class="form-control" /></td>';
