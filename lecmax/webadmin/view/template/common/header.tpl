	...
	<div id="container">
		...
		<nav id="column-left">
			<ul id="menu">
                ...
                <?php if($superadmin){?>
				<li id="supperadmin"><a class="parent"><i class="fa fa-wrench fa-fw"></i><span><?php echo mb_strtoupper($text_superadmin, 'utf8'); ?></span></a>
					<ul >
						<li ><a href="<?php echo $install; ?>"><?php echo $text_install;?></a></li>
						<li ><a href="<?php echo $install_cate; ?>"><?php echo $text_install_cate;?></a></li>
						<li ><a href="<?php echo $uninstall; ?>"><?php echo $text_uninstall;?></a></li>
						<li ><a href="<?php echo $adminmenu; ?>"><?php echo $text_admin_menu;?></a></li>
						<li ><a href="<?php echo $translatebackend; ?>"><?php echo $text_translate_backend;?></a></li>
						<li ><a href="<?php echo $permission; ?>"><?php echo $text_permission;?></a></li>
					</ul>
				</li>
				<?php }?>
			</ul>
